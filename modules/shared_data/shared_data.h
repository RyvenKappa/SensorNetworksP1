...
typedef struct PACKED {
    uint8_t     header    : 8;    //1B version and type and flags TODO
    ...
    uint16_t    hum       : 10;   //10b humidity as a percentage * 10
    ...
    uint16_t    light     : 10;   //10b light as a percentage * 10
    uint16_t    moisture  : 10;   //10b moisture as a percentage * 10
} frame_data_t;
