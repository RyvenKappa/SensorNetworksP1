...
\begin{table}[H]
    ...
    \begin{bytefield}[bitwidth=1.35em]{32}
        ...
        \bitbox{16}{Green} & \bitbox{16}{Blue} \\
        \bitbox{16}{Temperature} & \bitbox{10}{Humidity (\texttt{10b})} & \bitbox{6}{X\_Acc (MSB)}\\
        \bitbox{8}{X\_Acc (LSB)(\texttt{14b})} & \bitbox{10}{Light(\texttt{10b})} & \bitbox{14}{Y\_Acc (\texttt{14b})} \\
        \bitbox{10}{Moisture (\texttt{10b})} & \bitbox{14}{Z\_Acc (\texttt{14b})} & \bitbox{8}[bgcolor=lightgray]{}\\
     \end{bytefield}
